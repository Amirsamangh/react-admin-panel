...
return (
    <div className="container">
        ...
        <div className="text-right col-md-6 col-lg-8 m-auto my-3">
            <PrevPageButton />
        </div>
                ...
                <>
                    ...
                    >
                        <Form>
                            ...
                            <div className="d-flex justify-content-center text-center col-12 col-md-6 col-lg-8 mt-4 m-auto">
                                <SubmitButton />
                                <PrevPageButton className='me-2' type='button' />
                            </div>
                        </Form>
                    </Formik>
                </>
